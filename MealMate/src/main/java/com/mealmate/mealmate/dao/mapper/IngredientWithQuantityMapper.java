...
public class IngredientWithQuantityMapper implements RowMapper<Ingredient> {
    @Override
    public Ingredient mapRow(ResultSet rs, int index) throws SQLException {
        ...
        ingredient.setQuanity(rs.getFloat("quantity"));
        ingredient.setMeasure(rs.getString("unit"));
        return ingredient;
    }
}
